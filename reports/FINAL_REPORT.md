...
> 生成时间: 2026-06-01 00:30 · House STOCK Act PTR · 2023-03-09 起
...
<figure class="report-fig">
<img src="figures/04_buy_sell.png" alt="股票+期权：买入（含行权）vs 卖出 — 笔数与名义双饼图">
<figcaption>股票+期权：买入（含行权）vs 卖出 — 笔数与名义双饼图</figcaption>
</figure>
